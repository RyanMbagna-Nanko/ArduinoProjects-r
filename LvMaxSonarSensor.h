...
/* 
 *  pulse width modulation which we are not currently using
...
#define LEFT_COLLISION_AVOID_SENSOR_AN_PIN     A0
#define RIGHT_COLLISION_AVOID_SENSOR_AN_PIN    A1
// we can tie all the RX pins on the sensors to this digital pin in order
// to trigger simultaneous readings.  Go high to star getting readings.
#define COLLISION_AVOID_SENSOR_ENABLE_PIN      22  //BX Pins

#define Left_RX_PIN               24   //begins chain

#define Right_TX_PIN              30    //for pulse recognition
